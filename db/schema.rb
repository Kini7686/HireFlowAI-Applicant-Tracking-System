...
ActiveRecord::Schema[7.1].define(version: 2024_05_19_000006) do
  ...
  create_table "resume_profiles", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["processing_status"], name: "index_resume_profiles_on_processing_status"
    t.index ["user_id"], name: "index_resume_profiles_on_user_id"
  end
  ...
  add_foreign_key "resume_profiles", "users"
end
